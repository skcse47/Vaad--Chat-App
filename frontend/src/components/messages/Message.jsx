...
const Message = () => {
	...
	return (
		<div className={`chat chat-end`}>
			...
			<div className={`chat-bubble text-white bg-blue-500 pb-2`}>Namaste ji</div>
			<div className='chat-footer opacity-50 text-xs flex gap-1 items-center text-white'>12:15</div>
		</div>
	);
};
